...
import melanie.maronde.spring3.di.annotations.MessageProvider;
import melanie.maronde.spring3.di.annotations.MessageRenderer;
...
public class HelloWorld {
    ...
    public static void main(String[] args) {
        ...
        ctx.load("classpath:spring-application-config-annotationStyle.xml");
        ctx.refresh();
